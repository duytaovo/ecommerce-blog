...
export default function DashboardSidebar({ isOpenSidebar, onCloseSidebar }) {
  ...
  const sidebarConfig = [
    ...
    // ----------------------------------------------------------------------
    {
      ...
      items: [
        {
          title: t('dashboard.statics'),
          path: PATH_DASHBOARD.general.statics,
    ...
    // ----------------------------------------------------------------------
    {
      ...
      items: [
        {
          title: t('blogs.title'),
          path: PATH_DASHBOARD.app.blogs.root,
          icon: ICONS.blogs,
          children: [
            {
              title: t('blogs.list'),
              path: PATH_DASHBOARD.app.blogs.list,
              icon: ICONS.list,
            },
            {
              title: t('blogs.add'),
              path: PATH_DASHBOARD.app.blogs.add,
              icon: ICONS.addNew,
            },
          ],
        },
        ...
        {
          title: t('dashboard.brands.title'),
          path: PATH_DASHBOARD.app.brands,
          icon: ICONS.brands,
        },
        {
          ...
          children: [
            {
              ...
              path: PATH_DASHBOARD.app.products.list,
              icon: ICONS.list,
            },
            {
              title: t('products.add'),
              path: PATH_DASHBOARD.app.products.add,
              icon: ICONS.addNew,
            },
          ],
        },
        {
          ...
          children: [
            {
              title: t('dashboard.users.customer-list'),
              path: PATH_DASHBOARD.app.users.customer_list,
            },
            {
              title: t('dashboard.users.staff-list'),
              path: PATH_DASHBOARD.app.users.staff_list,
            },
          ],
        },
      ],
