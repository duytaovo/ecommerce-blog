...
// ----------------------------Blog------------------------------------
export const getBlogs = () => API.get(`/post/getposts`);
export const getBlogDetail = (postId, userId) =>
  API.get(`/post/getposts?postId=${postId}`);
export const addPost = (postBody) => API.post(`/post/create`, postBody);
export const editPost = (postBody, userId) =>
  API.patch(`/post/updatepost/${postBody.id}/${userId}`, postBody);
export const removePost = (postId, userId) =>
  API.delete(`/post/deletepost/${postId}/${userId}`);


// commentAPI.js
export const addComment = (commentBody) => 
  API.post('/comment-blog/add', commentBody);
...
export const deleteComment = (commentId) => 
  API.delete(`/comment-blog/deleteComment/${commentId}`);
