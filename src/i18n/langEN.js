export default {
  ...
  blogs: {
    ...
    title: 'Blog',
    'title-not-found': 'The post list is empty!',
    search: 'Search for posts ...',
    title: 'Post Name',
    'title-validation': 'Post name is a required field',
    'title-validation-len': 'Post name must be between 6 and 25 characters',
    desc: 'Description',
    'desc-validation': 'Description is a required field',
    'order-validation': 'Order is a required field',
    parent: 'Parent Post',
    status: 'Status',
    hidden: 'Hidden',
    visible: 'Visible',
    add: 'Add Post',
    'add-title': 'Add a New Post',
    edit: 'Edit Post',
    'edit-title': 'Edit Post',
    delete: 'Delete Post',
    'confirm-delete': 'Do you want to delete the post - {{nameInfo}}?',
    image: 'Image',
    pictures: 'Pictures',
    picturesNote: 'Pictures Note',
    available: 'Number of Products',
    list: 'Post list',
    video: 'Video',
    category: 'Category',
    create: 'Add blog',
    'add-success': 'Successfully added post.',
    save: 'Save Changes',
  },
  commentBlog: {
    ...
    search: 'Search for posts ...',
    title: 'Comment Name',
    'title-validation': 'Comment name is a required field',
    'title-validation-len': 'Comment name must be between 6 and 25 characters',
    desc: 'Description',
    'desc-validation': 'Description is a required field',
    'order-validation': 'Order is a required field',
