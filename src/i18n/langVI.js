...
export default {
  ...
  blogs: {
    ...
    title: 'Bài viết',
    'title-not-found': 'Danh sách bài đăng trống!',
    search: 'Tìm kiếm bài đăng ...',
    title: 'Bài đăng',
    'title-validation': 'Tên bài đăng là trường bắt buộc',
    'title-validation-len': 'Tên bài đăng phải từ 6 đến 25 ký tự',
    desc: 'Mô tả',
    'desc-validation': 'Mô tả là trường bắt buộc',
    'order-validation': 'Thứ tự là trường bắt buộc',
    parent: 'Bài đăng cha',
    status: 'Trạng thái',
    hidden: 'Đã ẩn',
    visible: 'Hiển thị',
    add: 'Thêm Bài đăng',
    'add-title': 'Thêm bài đăng mới',
    edit: 'Chỉnh sửa Bài đăng',
    'edit-title': 'Chỉnh sửa bài đăng',
    delete: 'Xóa Bài đăng',
    'confirm-delete': 'Bạn có muốn xóa bài đăng - {{nameInfo}} không?',
    image: 'Hình ảnh',
    pictures: 'Hình ảnh',
    picturesNote: 'Ghi chú Hình ảnh',
    available: 'Số lượng Sản phẩm',
    list: 'Danh sách bài đăng',
    video: 'Video',
    category: 'Danh mục',
    create: 'Thêm bài',
    'add-success': 'Thêm bài thành công',
    save: 'Lưu thay đổi',
  },
  commentBlog: {
    ...
    'confirm-delete': 'Bạn có muốn xóa bình luận - {{nameInfo}} không?',
    image: 'Hình ảnh',
    pictures: 'Hình ảnh',
    picturesNote: 'Ghi chú Hình ảnh',
